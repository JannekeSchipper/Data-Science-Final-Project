...
library(caTools)
library(tidyr)
setwd ("C:/Users/janne/OneDrive/Documenten/R/Coursera/CourseraTutorial/Data/Course 10 - Capstone Project/Coursera-SwiftKey/final")
...
# Read in data
dBlog <- readLines("en_US/en_US.blogs.txt", encoding = "UTF-8", skipNul = TRUE)
dNews <- readLines("en_US/en_US.news.txt", encoding = "UTF-8", skipNul = TRUE)
dTwitter <- readLines("en_US/en_US.twitter.txt", encoding = "UTF-8", skipNul = TRUE)
...
dBlog <- readRDS("dBlog.RData"); 
dNews <- readRDS("dNews.RData"); 
dTwitter <- readRDS("dTwitter.RData")
